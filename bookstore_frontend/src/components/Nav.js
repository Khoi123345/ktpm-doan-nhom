    ...
    render(){
        ...
        return(
            <nav className="navbar">
                ...
                <li className="link-item"><Link to={"/"} className="link">Trang chủ</Link></li>
                <li className="link-item"><Link to={"/search"} className="link">Sản phẩm</Link></li>
                <li className="link-item"><Link to={"/order"} className="link">Đơn hàng</Link></li>
                <li className="link-item"><Link to={"/cart"} className="link">Giỏ hàng</Link></li>
                {(this.state.admin)?
                    (
